...
enum kSdkInterruptId {
     kSdkInterruptId_NMI
    ,kSdkInterruptId_SysTick
    ,kSdkInterruptId_EXTI15_10
    ,kSdkInterruptId_DMA2_Stream0
    ,kSdkInterruptId_DMA2_Stream5
    ,kSdkInterruptId_AUDIO_OUT_SAIx_DMAx
    ,kSdkInterruptId_AUDIO_DFSDMx_DMAx_BUTTOM_LEFT
    ,kSdkInterruptId_AUDIO_DFSDMx_DMAx_BUTTOM_RIGHT
    ,kSdkInterruptId_BSP_SDMMC
    ,kSdkInterruptId_OTG_HS
    ,kSdkInterruptId_OTG_FS = kSdkInterruptId_OTG_HS
    ,kSdkInterruptId_Num
};
